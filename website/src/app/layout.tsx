import { Inter, IBM_Plex_Mono as Mono, Newsreader } from 'next/font/google'
...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body className="flex min-h-screen flex-col items-center justify-center scroll-smooth font-light text-neutral-900 leading-loose antialiased selection:bg-neutral-600 selection:text-white dark:bg-neutral-900 dark:text-neutral-200">
