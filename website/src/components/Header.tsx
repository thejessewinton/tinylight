...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-0 mx-auto flex h-14 w-full items-center justify-between bg-gradient-to-b from-neutral-900/75 px-8 backdrop-blur-sm sm:px-8 lg:h-20">
      <Link
        href="/"
